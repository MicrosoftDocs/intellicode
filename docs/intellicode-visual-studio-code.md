...
When using IntelliCode, you may see the error message "Couldn't download IntelliCode model. Please check your network connectivity or firewall settings.", or see similar messages in the IntelliCode output window pane in Visual Studio Code. IntelliCode starred suggestions may well not show up either. Problems with correct handling of proxies behind firewalls can cause this sort of issue.
