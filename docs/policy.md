...
- A Visual Studio 2019 Admin Role, see [Visual Studio Subscriptions Admin Responsibilities](/visualstudio/subscriptions/admin-responsibilities?view=vs-2019&preserve-view=true) for more information about the Admin role.
