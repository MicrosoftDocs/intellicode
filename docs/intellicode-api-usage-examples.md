...
1. You'll see an info window appear, below where you're hovering. If the function you hovered is found in IntelliCode API Usage Examples' list, a link to "See Real World Examples From GitHub" will appear in that window. Note: you may need to scroll the informational window to see the link.
